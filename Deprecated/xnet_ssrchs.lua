...
xnet_ssrchs_proto = Proto("xnet_ssrchs","xNet SSRCHS Protocol")
-- create a function to dissect it
function xnet_ssrchs_proto.dissector(buffer,pinfo,tree)
  udp_dst_f = pinfo.dst_port
  pinfo.cols.protocol = "xnet_ssrchs"
  local xnet_top_subtree = tree:add(xnet_ssrchs_proto,buffer(),"xNet Protocol Data")
...
udp_table:add(4201,xnet_ssrchs_proto)